...
## multi-class-aug
#datapath="./data/magnetic/magnetic_confirm_ver4_step1_1_one_bank_median" 
datapath="./data/magnetic/lets_cluster/magnetic_0_cluster"
#log_group="d"
...
#have to change log_group!!!!!!!!!!!!!!!
dataset_flags=($(for dataset in "${datasets[@]}"; do echo '-d '$dataset; done))

#DINO_Ours
python3 step1_3_run_patchcore.py --gpu 0 --seed 0 --save_patchcore_model --log_group magnetic_cluster_num_0 --log_project magnetic_cluster results patch_core \
-b wideresnet50 -le layer2 -le layer3 --pretrain_embed_dimension 1024 --target_embed_dimension 2048 --anomaly_scorer_num_nn 1 \
--patchsize 3 sampler -p 0.01 approx_greedy_coreset dataset --resize 224 --imagesize 224 --batch_size 1 --num_workers 0 \
"${dataset_flags[@]}" "$name" "$datapath" 
...
# python3 bin/run_patchcore.py --gpu 0 --seed 3 --save_patchcore_model --log_group IM224_Ensemble_L2-3_P001_D1024-384_PS-3_AN-1_S3 --log_online --log_project MVTecAD_Results results \
...
# python3 step1_3_run_patchcore.py --gpu 1 --seed 0 --save_patchcore_model --log_group DINO_naive --log_project Wafer_Results results patch_core \
# -b wideresnet50 -le layer2 -le layer3 --pretrain_embed_dimension 1024 --target_embed_dimension 2048 --anomaly_scorer_num_nn 1 \
# --patchsize 3 sampler -p 0.01 approx_greedy_coreset dataset --resize 224 --imagesize 224 --batch_size 1 --num_workers 0 \
# --subdatasets 0 --subdatasets 1 --subdatasets 2 --subdatasets 3 --subdatasets 4 "$name" "$datapath" 
...
# python3 bin/run_patchcore.py --gpu 0 --seed 22 --save_patchcore_model --log_group IM320_WR50_L2-3_P001_D1024-1024_PS-3_AN-1_S22 --log_online --log_project MVTecAD_Results results \
...
# python3 bin/run_patchcore.py --gpu 0 --seed 40 --save_patchcore_model --log_group IM320_Ensemble_L2-3_P001_D1024-384_PS-3_AN-1_S40 --log_online --log_project MVTecAD_Results results \
...
# python3 bin/run_patchcore.py --gpu 0 --seed 22 --save_patchcore_model --log_group IM320_WR50_L2-3_P001_D1024-1024_PS-5_AN-3_S39 --log_online --log_project MVTecAD_Results results \
...
# # Performance: Instance AUROC: 0.996, Pixelwise AUROC: 0.982, PRO: 0.949
# python3 bin/run_patchcore.py --gpu 0 --seed 88 --save_patchcore_model --log_group IM320_Ensemble_L2-3_P001_D1024-384_PS-5_AN-5_S88 --log_online --log_project MVTecAD_Results results \
