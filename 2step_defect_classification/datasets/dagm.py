...
class dagm(LT_Dataset):

    classnames_txt = "./datasets/dagm/dagm_confirm_ver4_1step_nonpatch/classnames.txt"
    train_txt = "./datasets/dagm/dagm_confirm_ver4_1step_nonpatch/dagm_LT_train.txt"
    test_txt = "./datasets/dagm/dagm_confirm_ver4_1step_nonpatch/dagm_LT_test.txt"

    # classnames_txt = "./datasets/dagm/dagm_confirm_ver4_1step_patch/classnames.txt"
    # train_txt = "./datasets/dagm/dagm_confirm_ver4_1step_patch/dagm_LT_train.txt"
    # test_txt = "./datasets/dagm/dagm_confirm_ver4_1step_patch/dagm_LT_test.txt"


    # classnames_txt = "./datasets/dagm/dagm_confirm_ver4_aug_test/classnames.txt"
    # train_txt = "./datasets/dagm/dagm_confirm_ver4_aug_test/dagm_LT_train.txt"
    # test_txt = "./datasets/dagm/dagm_confirm_ver4_aug_test/dagm_LT_test.txt"
